        ...
        {showDropdown && (
          <div className="absolute top-12 right-0 w-56 bg-black/40 backdrop-blur-md shadow-lg rounded-md p-3 flex flex-col gap-3 z-50">
            <div className="relative flex">
              {showSearch ? (
                ...
                >
                  ...
                  <button
                    type="button"
                    className="ml-1 p-1 text-gray-600 hover:bg-gray-200 rounded-full text-lg"
                ...
                <button
                  className="p-2 rounded-full text-gray-600 hover:text-gray-800 w-full"
            ...
            <div className="flex flex-col gap-2">
              <button className="px-5 py-2 text-sm font-medium text-purple-700 border border-purple-300 rounded-md hover:bg-purple-50 hover:border-purple-400 w-full">
                Sign in
              </button>
              <button
                style={{ background: '#953BF5' }}
                className="px-5 py-2 text-sm font-medium text-white rounded-md hover:shadow-md transform hover:-translate-y-0.5 w-full"
              >
                Sign Up
              </button>
            </div>
